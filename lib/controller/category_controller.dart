...
class CategoryController extends GetxController implements GetxService {
  ...
  void getSubCategoryList(String? categoryID) async {
    ...
    if (response.statusCode == 200) {
      _subCategoryList = [];
      log("subCategoryList: ${response.body}");
  ...
  void setSubCategoryIndex(int index, String? categoryID) {
    ...
    if (SearchController.to.searchItemList != null) {
      SearchController.to.searchItemList = null;
      update();
    }
    getCategoryItemList(_subCategoryList![index].id.toString(), 1, _type, true);
  }
  ...
  void getCategoryItemList(
    ...
    if (response.statusCode == 200) {
      ...
      Get.find<SearchController>().sortItemSearchList(productPage: true);
